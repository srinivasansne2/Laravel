...
@section('main')
<div class="row">
    <h5><i class="fa-regular fa-pen-to-square"></i> Edit Product</h5>
    <hr>
    <nav class="my-3">
        <ol class="breadcrumb">
        ...
        <form action="/products/update/{{$product->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    name="name" id="name" placeholder="Enter Product Name" value="{{old('name',$product->name)}}">
                    @if($errors->has('name'))
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    name="mrp" id="mrp" placeholder="Enter Product M.R.P" value="{{old('mrp',$product->mrp)}}">
                    @if($errors->has('mrp'))
                ...
                <div class="col-md-6">
                    ...
                    name="sellingprice" id="sellingprice" placeholder="Enter Selling Price" value="{{old('sellingprice',$product->price)}}">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    style="resize: none; height: 150px;" placeholder="Enter Product Description">{{old('description',$product->description)}}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    name="productimg" id="[productimg]" value="{{old('productimg',$product->image)}}">
